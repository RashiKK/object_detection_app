...
SERIAL_PORT = 'COM5'  # Update this with the correct serial port name
BAUD_RATE = 9600
...
def detect_objects_weapon(img):
    ...
    if weapon_detected:
        ...
        if current_time - last_sms_time_weapon > sms_cooldown_duration:
            ...
            send_sms(f"{current_time_str} - Weapon detected at CAM1, Location: NSU-GRNDFLR")
...
cap.set(cv2.CAP_PROP_FRAME_WIDTH, 854)  # Adjust resolution for faster processing
